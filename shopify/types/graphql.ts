...
export type GetDetailArticleQuery = { blog?: { articleByHandle?: { id: string, title: string, handle: string, excerpt?: string | null, contentHtml: string, publishedAt: string, image?: { url: string, altText?: string | null } | null, author: { name: string }, titleImage?: { reference?: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage', image?: { url: string, altText?: string | null, width?: number | null, height?: number | null } | null } | { __typename: 'Metaobject' } | { __typename: 'Model3d' } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video' } | null } | null, tileBanner?: { reference?: { __typename: 'Collection' } | { __typename: 'GenericFile' } | { __typename: 'MediaImage', image?: { url: string, altText?: string | null, width?: number | null, height?: number | null } | null } | { __typename: 'Metaobject' } | { __typename: 'Model3d' } | { __typename: 'Page' } | { __typename: 'Product' } | { __typename: 'ProductVariant' } | { __typename: 'Video', sources: Array<{ url: string, mimeType: string, format: string, width: number, height: number }>, previewImage?: { url: string, altText?: string | null } | null } | null } | null } | null } | null };
