...
export type CartCreateMutation = { cartCreate?: { cart?: { id: string, createdAt: string, updatedAt: string, checkoutUrl: string, lines: { edges: Array<{ node: { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } | { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } }> }, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode }, subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, attributes: Array<{ key: string, value?: string | null }> } | null, userErrors: Array<{ code?: CartErrorCode | null, field?: Array<string> | null, message: string }> } | null };
...
export type CartLinesAddMutation = { cartLinesAdd?: { cart?: { id: string, createdAt: string, updatedAt: string, checkoutUrl: string, lines: { edges: Array<{ node: { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } | { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } }> }, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode }, subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, attributes: Array<{ key: string, value?: string | null }> } | null, userErrors: Array<{ code?: CartErrorCode | null, field?: Array<string> | null, message: string }> } | null };
...
export type CartLinesRemoveMutation = { cartLinesRemove?: { cart?: { id: string, createdAt: string, updatedAt: string, checkoutUrl: string, lines: { edges: Array<{ node: { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } | { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } }> }, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode }, subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, attributes: Array<{ key: string, value?: string | null }> } | null, userErrors: Array<{ code?: CartErrorCode | null, field?: Array<string> | null, message: string }> } | null };
...
export type GetProductsQuery = { products: { nodes: Array<{ id: string, title: string, handle: string, description: string, publishedAt: string, category?: { name: string } | null, collections: { nodes: Array<{ id: string, handle: string, title: string }> }, images: { nodes: Array<{ url: string, altText?: string | null }> }, variants: { edges: Array<{ node: { id: string, title: string, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> } }> } };
...
export type CartFragment = { id: string, createdAt: string, updatedAt: string, checkoutUrl: string, lines: { edges: Array<{ node: { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } | { id: string, quantity: number, merchandise: { id: string, title: string, sku?: string | null, quantityAvailable?: number | null, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, selectedOptions: Array<{ name: string, value: string }>, image?: { url: string, altText?: string | null } | null, product: { id: string, handle: string, title: string, totalInventory?: number | null } } } }> }, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode }, subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, attributes: Array<{ key: string, value?: string | null }> };
...
export type GetCollectionListQuery = { collection?: { title: string, description: string, products: { nodes: Array<{ id: string, title: string, handle: string, publishedAt: string, description: string, category?: { name: string } | null, images: { nodes: Array<{ url: string, altText?: string | null }> }, variants: { edges: Array<{ node: { id: string, title: string, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> } }> } } | null };
...
export type GetProductRecommendationsQuery = { relatedProducts?: Array<{ id: string, title: string, handle: string, description: string, publishedAt: string, productType: string, category?: { name: string } | null, collections: { nodes: Array<{ id: string, handle: string, title: string }> }, images: { nodes: Array<{ url: string, altText?: string | null }> }, variants: { edges: Array<{ node: { id: string, title: string, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> } }> | null, complementaryProducts?: Array<{ id: string, title: string, handle: string, description: string, publishedAt: string, productType: string, category?: { name: string } | null, collections: { nodes: Array<{ id: string, handle: string, title: string }> }, images: { nodes: Array<{ url: string, altText?: string | null }> }, variants: { edges: Array<{ node: { id: string, title: string, price: { amount: string, currencyCode: CurrencyCode }, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> } }> | null };
